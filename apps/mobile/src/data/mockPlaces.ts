...
export const mockPlaces: Place[] = [
    {
        ...
        distanceKm: 2.1,
        rewardXp: 90,
        location: { latitude: 31.0074, longitude: 28.988 },
        tags: ["Sunset", "Citylights", "Open air"]
    },
    {
        id: "old-town-galleria",
        name: "Old Town Galleria",
        category: "Culture",
        ...
        distanceKm: 1.3,
        rewardXp: 70,
        location: { latitude: 30.9979, longitude: 28.964 },
        tags: ["Mural", "AR", "Walk"]
    },
    {
        id: "marina-lights",
        ...
        distanceKm: 2.6,
        rewardXp: 110,
        location: { latitude: 31.0032, longitude: 28.992 },
    ...
    },
    {
        ...
        distanceKm: 0.9,
        rewardXp: 60,
        location: { latitude: 31.0004, longitude: 28.97 },
